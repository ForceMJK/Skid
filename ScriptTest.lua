...
local Library = {
	Themes = {
		Legacy = {
			Main = Color3.fromHSV(109/360, 110/255, 108/255),
			Secondary = Color3.fromHSV(109/360, 110/255, 108/255),
			Tertiary = Color3.fromHSV(205/360, 84/255, 75/255),
...
function Library:change_theme(toTheme)
	...
	Library.DisplayName.Text = "Seja Bem Vindo!, <font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*102) .. "," .. math.floor(c.B*102) .. ")'> <b>" .. LocalPlayer.DisplayName .. "</b> </font>"
...
function Library:create(options)
	...
	local displayName; do
		...
		local displayName = profile:object("TextLabel", {
			RichText = true,
			Text = "Bem Vindo, <font color='rgb(" ..  math.floor(c.R*255) .. "," .. math.floor(c.G*255) .. "," .. math.floor(c.B*255) .. ")'> <b>" .. LocalPlayer.DisplayName .. "</b> </font>",
			TextScaled = true,
